...
\begin{itemize}
	...
	\item \textbf{Competing Grammars, general form}: 2 variants are available to a speaker with overlapping functions (e.g. the same meaning), and can't both be used at the same time.
		\begin{itemize}
			\item E.g. two versions of the same syntactic head, and which occupy the same place in the phrase structure. 
...
\begin{frame}{Example: -\textipa{In}$\sim$-\textipa{IN}}
	...
	\begin{itemize}
		...
		\item Is it specialized for different grammatical contexts? Partially, along a nominal$\leftrightarrow$verbal dimension \citep{labov1989}.
		\item It it specialized for different speech styles? Partially.
	\end{itemize}
