...
\begin{frame}{Now for something completely different: gender}
		\begin{itemize}
		\item \textbf{Linguistic sex/gender effects:} it is well known that speaker-sex has a stochastic effect on the frequency with which linguistic variants are used \small{\citep[][and many, many more]{labov2001, eckert2011}}.
		...
		(\textsl{in utero}, esp. weeks 8-24 for humans), affecting primary/secondary sex characteristics, and:
			\begin{itemize}
				...
				\item \textbf{Behaviour:} mating behaviours in various mammals, pair-bonding and birdsong in birds, \textbf{gender identity} in humans \small{\citep{hinesetal2002, berenbaumbailey2003, hinesetal2004, cohenbendahanetal2005, auyeungetal2009}}, and \textbf{gendered social learning in humans} \small{\citep{hinesetal2016}}.
			\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}{How does it relate to the project?}
		\begin{itemize}
			...
			\item Some measures of hormone exposure (e.g. 2D:4D hand digit ratio) and gender identity (e.g. continuous gender scale) are fairly cheap and quick.
		\end{itemize}
\end{frame}
