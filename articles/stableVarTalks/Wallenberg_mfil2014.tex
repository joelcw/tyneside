...
\subsection{Examples: h-dropping, -\textipa{In}$\sim$-\textipa{IN}}
\begin{frame}{Example: \textsl{h}-dropping in Manchester}
	\begin{itemize}
		...
		\item The variation is phonological in nature (i.e. a new allophone, or total loss of a phoneme), as it interacts with the phonological rule of [\textipa{\*r}]-insertion (``linking'' \textsl{r})
	\end{itemize}
...
\begin{frame}{Conclusions}
	\begin{block}{Further Research}
		\begin{itemize}
			...
			\item Look into other ``stability'' data sets (for instability, and for within-speaker categorical variation specialized along a continuous dimension).
			\item Appropriately parameterize phonological variation.
			\item Extend specialization account to the interaction of phonological and phonetic change (e.g. allophonic split in vowels).
		\end{itemize}
	\end{block}
