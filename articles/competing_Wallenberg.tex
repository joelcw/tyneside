...
There is no \emph{formal} distinction between the optional flavors of C which produced (non)topicalization in (\ref{princetop2_first}) and (\ref{princeuntop2}) and the competing flavors of $v$ which were involved in an OV to VO word order change.
