...
This is shown in the chart below, with data plotted at 50 year intervals from the Icelandic Parsed Historical Corpus \citep[IcePaHC][]{icepahc09}.


\begin{figure}
    \begin{center}
    \includegraphics[scale=.7]{whetherifIce.pdf}
    \caption{Replacement in Icelandic of \textsl{ef} (``if'') by \textsl{hvort} (``whether'') in embedded polar questions. N = 397 clauses, IcePaHC.}
    \end{center}
    \label{hvort}
\end{figure}
