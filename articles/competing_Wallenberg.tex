...
This is shown in the chart below, with data plotted at 50 year intervals from the Icelandic Parsed Historical Corpus \citep{icepahc09}.


\begin{figure}
    \begin{center}
    
    \caption{Replacement in Icelandic of \textsl{ef} (``if'') by \textsl{hvort} (``whether'') in embedded polar questions. N = 397 clauses. }
    \end{center}
    \label{hvort}
\end{figure}
