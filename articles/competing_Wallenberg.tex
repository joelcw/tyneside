...
It could be that the Principle of Contrast does not involve the application of context-specific pressures that are intended to increase variant A's abundance in one context and V's abundance in a different context, as we outlined above.
