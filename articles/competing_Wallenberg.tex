...
\notejoe{Provisional wording begins here}

In this section, we have argued that a parsimonious explanation for optionality in syntax is the competition for use of functional heads that differ in their movement triggering features.
This explanation is identical to what has previously been called ``Competing Grammars."
We also argue that Competing Grammars can be extended to phonological variation as well, but requires rethinking of how variation is typically accounted for within phonological theory.
Importantly, a Competing Grammars analysis places the explanation choosing one grammar or another outside of the grammatical system itself.
...
We will be turning to ``Stabilization'' for this purpose.

\notejoe{End provision}
