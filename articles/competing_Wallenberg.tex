...
In English and Icelandic {\it whether}/{\it if} variation, the input to the grammar is the right periphery of an embedded question, and {\it if} and {\it whether} are variably pronounced.\notejoe{I'm making up words}
\begin{exe}
\ex {\it if}/{\it whether} in embedded questions\\
	\Treek[3]{3}{
		&\K{\includegraphics[width = 0.3\textwidth]{figures/whetherif_in.pdf}}\AR[-4]{dl}_{p}\AR[-4]{dr}^{(1-p)}\\
...
Likewise {\sl t}/{\sl d} deletion is sensitive the featural properties of the preceding and following segments, morphological boundaries, frequency of the target word, and as recently demonstrated by \citet{MacKenzie.Tamminga2012, tamminga2014}, whether or not {\sl t}/{\sl d} deletion applied at its most recent opportunity. 
