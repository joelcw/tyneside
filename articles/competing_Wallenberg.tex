...
The maximally simple syntactic system, in which the locus of syntactic variation must be the featural content of a syntactic head, has a further consequence that Kroch did not consider: all ``optional'' syntactic operations must also be instances of competing grammars, i.e. morphosyntactic doublets.
