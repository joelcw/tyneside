...
Below we describe a small, completed pilot study, a larger pilot study in progress, and a future large-scale investigation into whether there is an endocrine basis for differential production frequencies of linguistic variants by gender.
...
\item Can we demonstrate a continuous biological basis for the gender continuum, 
...
\bibliography{poster refs} % Use the example bibliography file sample.bib
