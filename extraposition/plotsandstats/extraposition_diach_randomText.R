...
foo <- read.delim("../queriesandoutput/cprelExtrapos.ymeb.cod.fixed.ooo",header=F,sep=":")
...
foo <- read.delim("../queriesandoutput/cprelExtrapos.ice.cod.fixed.ooo",header=F,sep=":")
...
foo <- read.delim("../queriesandoutput/cprelExtrapos.fre.cod.fixed.ooo",header=F,sep=":")
...
foo <- read.delim("../queriesandoutput/cprelExtrapos.port.cod.fixed.ooo",header=F,sep=":")
...
ex.data <- subset(foo,Extraposed != "z" & Clause != "z" & Year != "z" & Year != "0" & Year != "" & Position == "sbj" & Weight != "z" & Language != "")
